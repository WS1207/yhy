...
class Xwz_Nav extends React.Component{
    ...
    render(){
        ...
        if(this.state.index===0){
            var data=this.props.xwz_con1;
        }else if(this.state.index===1){
            var data=this.props.xwz_con2;
        }else if(this.state.index===2){
            var data=this.props.xwz_con3;
        }else if(this.state.index===3){
            var data=this.props.xwz_con4;
        }else if(this.state.index===4){
            var data=this.props.xwz_con5;
        }
        const datas=data.map((v,i)=><Xwz_cons key={i}  data={v}/>);
        return(
            <div className="xwz_bigbox">
...
class Xwz_cons extends React.Component{
    constructor(props){
        super(props);
    }
    render(){
        ...
        if(data.title){
            var title=<div className="xwz_block"></div>;
        }
        return(
            <div>
                <div className="xwz_title">
                    {title}
                    <div className="xwz_smalltitle">{data.title}</div>
                </div>
                <div className="xwz_content">
                    <p>{data.cons}</p>
                    <p>{data.eng}</p>
                </div>
                <div className="xwz_img">
